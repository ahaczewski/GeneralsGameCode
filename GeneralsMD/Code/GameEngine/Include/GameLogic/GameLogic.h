...
//typedef std::hash_map<ObjectID, Object *> ObjectPtrHash;
...
private:
	...
	*/
	typedef std::hash_map< AsciiString, BuildableStatus > BuildableMap;
	...
	*/
	typedef std::hash_map< AsciiString, ConstCommandButtonPtr > ControlBarOverrideMap;
